...
const formattedItems = computed(() => {
  ...
  return list.data.value.data.map(item => ({
    ...item,
    id: item.id,
...
function saveCompany() {
  ...
  if (companyData.value.catchPhrase)
    obj.catchPhrase = companyData.value.catchPhrase;
...
function setField(target: Record<string, string>, field: string, e: Event) {
...
<template>
    ...
    <template #field-address="{ value, update }">
      <div class="flex items-center gap-2 mt-1">
        ...
        <Button
          size="sm"
          variant="outline"
          @click="openAddressModal(value, update)"
          >Edit</Button
        >
      </div>
    </template>
    ...
    <template #field-company="{ value, update }">
      <div class="flex items-center gap-2 mt-1">
        ...
        <Button
          size="sm"
          variant="outline"
          @click="openCompanyModal(value, update)"
          >Edit</Button
        >
      </div>
    </template>
  ...
  <Dialog v-model="addressModalOpen">
    <div class="space-y-4">
      ...
      <div class="flex justify-end gap-2">
        <Button variant="outline" @click="addressModalOpen = false"
          >Cancel</Button
        >
  ...
  <Dialog v-model="companyModalOpen">
    <div class="space-y-4">
      ...
      <div class="flex justify-end gap-2">
        <Button variant="outline" @click="companyModalOpen = false"
          >Cancel</Button
        >
