...
export function formatSettingValue(
  setting: { key: string; value: string | null; isPublic: boolean | number },
  reveal: boolean
): string {
...
const OPERATORS: Record<string, (col: any, val: any) => any> = {
  "=": eq,
  "!=": ne,
  ">": gt,
  ">=": gte,
...
function printTable(rows: Record<string, any>[], cols: string[]) {
...
Usage:
  ...
  npx tsx scripts/inspect-db.ts --setting app_name
`);
}
